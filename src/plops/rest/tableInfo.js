...
module.exports.getTableFields = async function getTableFields(resource) {
  const sql = `
  SELECT
    cols.column_name,
    cols.data_type,
...
module.exports.getTableComments = async function getTableComments(resource) {
  const sql = `
...
module.exports.getTableForeignKeys = async function getTableForeignKeys(
  resource
) {
  const sql = `
SELECT
